      ...
      body: Column(
        ...
        children: [
          const Padding(
            ...
            child: Text("어떻게?", style: TextStyle(color: Color.fromARGB(0xff, 0x59, 0x59, 0x59), fontSize: 14.0),)
          ),
          Padding(
              ...
              children: [
                Expanded(
                  child: GradientButton(
                    onButtonPress: () {context.read<WizardCubit>().toWho(context, textEditingController); },
                    message: 'Continue',
                  ),
                ),
              ]
