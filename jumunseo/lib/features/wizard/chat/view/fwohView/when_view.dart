...
class WhenView extends StatefulWidget{
  ...
  @override
  State<WhenView> createState() => _WhenViewState();
}

class _WhenViewState extends State<WhenView> {
      ...
      body: Column(
        ...
        children: [
          const Padding(
            ...
            child: Text("언제?", style: TextStyle(color: Color.fromARGB(0xff, 0x59, 0x59, 0x59), fontSize: 14.0),)
          ),
          Padding(
